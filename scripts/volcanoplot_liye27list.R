...
Top_list <- c("STAT1","JAK2","B2M","KPNA4","NAA38","PPP6C","DYNC2LI1","LZTR1","RPRD2","ATP5B",
              "BORCS6","NOP14","WASHC4","NAMPT","RNF31","POLR2L","SDHB","SRSF1","SRP14","CDIPT")
output_path = "/Users/yujijun/Dropbox (Partners HealthCare)/ImmuneScreens_QCoutput/Top_bottom"
#draw volcano plot for all verified
for(i in seq(1,length(all_file_list),1)){
  print(figure_name[i])
  volcanodisplaymultigene(all_file_list[i],Top_list,figure_name[i],output_path)
}
