...
volcanodisplaysinglegene <- function(file_path, verfied_gene, figure_name, output_path){
  source('./R/Volcano.R')
  require(MAGeCKFlute)
  #input data
  ...
  if(verfied_gene %in% dd.rra$Official){
    ...
    print(paste("There isn't CARM1 gene in ",figure_name))
  }
}
